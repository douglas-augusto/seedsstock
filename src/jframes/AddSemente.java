...
public class AddSemente extends JInternalFrame {
    ...
    public AddSemente() {
        ...
        rdbtnD.setFont(new Font("Tahoma", Font.PLAIN, 11));
        ...
        lblValidade.setFont(new Font("Tahoma", Font.PLAIN, 11));
        ...
        textArea_1.setBounds(405, 44, 346, 233);
    ...
    public void lerTextFields() {
        ...
        s.setNome(textField.getText());
        s.setEspecie(textField_1.getText());

        try {
            s.setQuant(Integer.parseInt(textField_2.getText()));
        } catch (NumberFormatException ex) {
            s.setQuant(0);
        }

        try {
            s.setDia_col(Integer.parseInt(textField_3.getText()));
        } catch (NumberFormatException ex) {
            s.setDia_col(0);
        }
        try {
            s.setMes_col(Integer.parseInt(textField_4.getText()));
        } catch (NumberFormatException ex) {
            s.setMes_col(0);
        }
        try {
            s.setAno_col(Integer.parseInt(textField_5.getText()));
        } catch (NumberFormatException ex) {
            s.setAno_col(0);
        }

        try {
            s.setPreco_compra(Float.parseFloat(textField_6.getText()));
        } catch (NumberFormatException ex) {
            s.setPreco_compra((float) 0.0);
        }
        try {
            s.setPreco_venda(Float.parseFloat(textField_12.getText()));
        } catch (NumberFormatException ex) {
            s.setPreco_venda((float) 0.0);
        }
        try {
            s.setDia_val(Integer.parseInt(textField_7.getText()));
        } catch (NumberFormatException ex) {
            s.setDia_val(0);
        }

        try {
            s.setMes_val(Integer.parseInt(textField_8.getText()));
        } catch (NumberFormatException ex) {
            s.setMes_val(0);
        }
        try {
            s.setAno_val(Integer.parseInt(textField_9.getText()));
        } catch (NumberFormatException ex) {
            s.setAno_val(0);
        }

        s.setOrigem(textField_10.getText());
        s.setFornecedor(textField_11.getText());
        //s.setCondicoes_plantil(textArea);
        //s.setObservacoes(textArea_1.getText());
